...
**The demo** is `src/`. It runs, it is playable — roughly 1,800 lines of engine in
`src/core/`, 700 of content in `src/content/`, 1,700 of browser client in
`src/web/` — and every claim in this document is checked against the code.

**The full game** is `docs/story/` and `docs/STORY_MACHINE.md`. It is written
down and not built. Storylets, roads, twelve actors, the dog, deterioration —
...
| `docs/NEXT_STEPS.md` (what to do to the demo next) | `docs/REWRITE.md` (marked stale) |
| `docs/BEAT_ZERO_PLAN.md` (the spike that shipped) | `docs/story/BEAT_ZERO.md` (the spec it was cut from) |
