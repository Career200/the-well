...
export const belowSubjects: Record<string, BelowSubject> = {
  ...
  water: {
    ...
    extra: 'Sometimes the water shivers, as if it feels the cold too.',
  },
  walls: {
    id: 'walls',
    name: 'walls',
    ...
    extra: 'A name is scratched into the third course, high up, and to all but you it looks like damp old cracks.',
  },
  sky: {
    id: 'sky',
    name: 'sky',
  ...
  silt: {
    ...
    extra:
      'You press hard enough and the mud lets out a small pocket of sour air that bubbles to the surface and breaks without a sound.',
  },
  ring: {
    id: 'ring',
    ...
    extra: 'It turns on the finger now when the water is troubled. The finger is thinner than it was.',
  },
  whistle: {
    id: 'whistle',
    ...
    extra:
      "Eleven days is not a long walk to make a child happy. You've walked for years by then, and it was the only thing you had on you that was meant for somebody else.",
  },
  knife: {
    id: 'knife',
    ...
    extra: 'The blade is still bright under the mud, wedged so deep between the stones that nothing down here will ever turn it.',
  },
  coat: {
    id: 'coat',
    ...
    extra: 'It rips from under you when the water is disturbed, tearing itself further.',
  },
};
